...
class TransmissionDownloaderTest {
    ...
    fun name() {
        val task = DownloadTask(
            ...
            listOf(Path("/downloads/[Nekomoe kissaten&VCB-Studio] Hataraku Saibou [Ma10p_1080p]/[Nekomoe kissaten&VCB-Studio] Hataraku Saibou [01][Ma10p_1080p][x265_flac_2ac3].mkv")),
            Path("/downloads"),
