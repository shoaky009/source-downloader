 ...
 */
interface TorrentDownloader : AsyncDownloader, BatchFileMover {

    override fun move(sourceItem: SourceItem, file: FileContent): Boolean {
        throw UnsupportedOperationException("Use batchMove method")
    }
    ...
    override fun replace(itemContent: ItemContent): Boolean {
        ...
        for (sourceFile in itemContent.fileContents) {
            ...
            try {
                val result = batchMove(itemContent)
                if (result.success) {
